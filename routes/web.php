...
Route::post('/cart/apply-coupon', [CartController::class, 'apply_coupon_cart'])->name('cart.coupon.apply');
Route::delete('/cart/remove-coupon', [CartController::class, 'remove_coupon_cart'])->name('cart.coupon.remove');
...
Route::post('/contact', [HomeController::class, 'contact_store'])->name('home.contact.store');
...
Route::middleware(['auth', AuthAdmin::class])->group(function() {
    ...
    Route::get('/admin/slide/{slide_id}/edit', [AdminController::class, 'slide_edit'])->name('admin.slide.edit');
    Route::put('/admin/slide/update', [AdminController::class, 'slide_update'])->name('admin.slide.update');
    Route::delete('/admin/slide/{slide_id}/delete', [AdminController::class, 'slide_delete'])->name('admin.slide.delete');
