    ...
    <div class="main-content-wrap">
        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.update') }}">
            ...
            <div class="wg-box">
                ...
                @error('name') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                ...
                @error('slug') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                ...
                <div class="gap22 cols">
                    ...
                    @error('category') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                    ...
                    @error('brand') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                </div>
                ...
                @error('short_description') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                ...
                @error('description') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="wg-box">
                <fieldset>
                ...
                @error('image') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                ...
                @error('images') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                ...
                <div class="cols gap22">
                    ...
                    @error('regular_price') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                    ...
                    @error('sale_price') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="cols gap22">
                    ...
                    @error('SKU') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                    ...
                    @error('quantity') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="cols gap22">
                    ...
                    @error('stock_status') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                    ...
                    @error('featured') <span class="alert alert-danger text-2xl font-semibold text-danger">{{ $message }}</span> @enderror
                </div>
