    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.category.update') }}" method="POST" enctype="multipart/form-data">
                ...
                @error('name') <span class="alert alert-danger text-center font-semibold text-2xl">{{ $message }}</span> @enderror
                <fieldset class="name">
                ...
                @error('slug') <span class="alert alert-danger text-center font-semibold text-2xl">{{ $message }}</span> @enderror
                <fieldset>
                ...
                @error('image') <span class="alert alert-danger text-center font-semibold text-2xl">{{ $message }}</span> @enderror
                <div class="bot">
                    <div></div>
