                            ...
                            @foreach($categories as $category)
                                <li class="list-item">
                                    <span class="menu-link py-1">
                                        <input type="checkbox" name="categories" value="{{ $category->id }}" class="chk-category" @if(Str::is($f_categories, $category->id)) checked  @endif>
                                        {{ $category->name }}
                                    </span>
                    ...
                    <div class="search-field multi-select accordion-body px-0 pb-0">
                        <ul class="list list-inline mb-0 brand-list">
                            @foreach($brands as $brand)
                                <li class="list-item">
                                    <span class="link py-1">
                                        <input type="checkbox" name="brands" id="brands" value="{{ $brand->id }}" class="chk-brand" @if(Str::is($f_brand, $brand->id)) checked @endif>
                                        {{ $brand->name }}
                                    </span>
