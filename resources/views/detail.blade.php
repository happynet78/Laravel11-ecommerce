                ...
                <div class="product-single__media" data-media-type="vertical-thumbnail">
                    ...
                    <div class="product-single__thumbnail">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/thumbnails') }}/thumb_{{$product->image}}" width="104" height="104" alt="" />
                                </div>
                                @foreach(explode(',', $product->images) as $gimg)
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/thumbnails') }}/thumb_{{$gimg}}" width="104" height="104" alt="" />
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="product-single__reviews-item">
                            ...
                            <div class="customer-review">
                                ...
                                <div class="review-text">
                                    <p>Nam libero tempore, cum soluta nobis est eligendi option cumquat nihil impeded quo minus id quod
